function doPost(e) {
  try {
    ...
    var subject = "Pemberitahuan: Pengiriman Formulir";
    var message =
      "Halo, ada laporan pekerjaan baru silahkan cek disini https://docs.google.com/spreadsheets/d/1EPVMA1z5KexAzMiewBpeOXcNzdknrxGuoYWiy34WeGg/edit#gid=0\n\nDetail:\nEmail: " +
      email;
    var nama = e.parameter.nama;
    MailApp.sendEmail({
      to: "workshopppi7@gmail.com", // Gantilah dengan alamat email penerima yang sebenarnya
      subject: subject,
      body: message,
    });
    ...
    return ContentService.createTextOutput( // kembali ke hasil JSON behasil
      JSON.stringify({
        "Data telah terkirim": "Petugas kami akan meresponse laporan anda!",
...
function setup() {
  ...
  SCRIPT_PROP.setProperty(
    "1EPVMA1z5KexAzMiewBpeOXcNzdknrxGuoYWiy34WeGg",
    doc.getId()
  );
}
/**
...
function uploadFileToGoogleDrive(data, file, nama, email, e) {
  try {
    var dropbox = "Foto Laporan Kerusakan";
    var folder,
